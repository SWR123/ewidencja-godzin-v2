...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Check session defensively: a stale/invalid session cookie can make
      // /api/auth/session return an empty body (JWE decode error), which would
      // otherwise throw JSON.parse and falsely report a login failure.
      ...
      try {
        ...
        // Ignore: the session cookie was already set by signIn() above.
      }
